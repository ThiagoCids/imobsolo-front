 ...
 * 
 * POR QUÊ?
 * - Permite ao usuário solicitar um link para redefinir a senha.
 * - Inclui validação básica de e-mail e feedback visual.
 * - Simula envio de e-mail com delay para futura integração com API.
 */
